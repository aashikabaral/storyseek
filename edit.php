   ...
   <div class="container mt-5" style="margin-top: 13rem!important;">
        ...
        <?php foreach($query as $q){ ?>
            <form method="POST">
                ...
                <button class="btn btn-dark" name="update" style="background-color: #4CAF50; border: none; color: #219150; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block;
